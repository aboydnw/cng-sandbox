...
const COLORMAP_GRADIENTS: Record<string, string> = {
  ...
  inferno:
    "linear-gradient(90deg, #000004, #420a68, #932667, #dd513a, #fcffa4)",
  magma: "linear-gradient(90deg, #000004, #3b0f70, #8c2981, #de4968, #fcfdbf)",
  cividis:
    "linear-gradient(90deg, #00224e, #123570, #507aa2, #94a866, #fdea45)",
  terrain:
    "linear-gradient(90deg, #333399, #00b300, #ffe066, #8b4513, #ffffff)",
