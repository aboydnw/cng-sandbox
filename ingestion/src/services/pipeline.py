...
async def run_pipeline(job: Job, input_path: str, db_session_factory) -> None:
    ...
    try:
        ...
        dataset = Dataset(
            ...
            parquet_url=f"{get_settings().public_storage_url}/{converted_key}" if format_pair.dataset_type == DatasetType.VECTOR else None,
            cog_url=f"{get_settings().public_storage_url}/{converted_key}" if format_pair.dataset_type == DatasetType.RASTER else None,
